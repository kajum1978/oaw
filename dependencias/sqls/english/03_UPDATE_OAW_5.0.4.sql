...
INSERT INTO cartucho (id_cartucho, nombre, instalado, aplicacion, numrastreos, numhilos, id_guideline) VALUES (10, 'es.inteco.accesibilidad.CartuchoAccesibilidad', 1, 'Accessibility', 15, 50, 10);
...
INSERT INTO observatorio_tipo (id_tipo, name) VALUES ('4', 'OTHERS');
...
INSERT INTO ambitos_lista (id_ambito, nombre) VALUES ('1', 'AGE'), ('2', 'CCAA'), ('3', 'EELL'), ('4', 'Others');
...
INSERT INTO complejidades_lista (id_complejidad, nombre, profundidad, amplitud) VALUES(1, 'Low', 2, 2);
INSERT INTO complejidades_lista (id_complejidad, nombre, profundidad, amplitud) VALUES(2, 'Medium', 4, 8);
INSERT INTO complejidades_lista (id_complejidad, nombre, profundidad, amplitud) VALUES(3, 'High', 4, 11);
...
INSERT INTO clasificacion_etiqueta (id_clasificacion, nombre) VALUES ('1', 'Thematic'), ('2', 'Distribution'), ('3', 'Recurrence');
...
INSERT INTO clasificacion_etiqueta (id_clasificacion, nombre) VALUES ('4', 'Others');
ALTER TABLE ambitos_lista ADD descripcion VARCHAR(1024) NULL;
UPDATE ambitos_lista SET descripcion = 'General State Administration' WHERE id_ambito = 1;
UPDATE ambitos_lista SET descripcion = 'Autonomous communities' WHERE id_ambito = 2;
UPDATE ambitos_lista SET descripcion = 'Local Entities' WHERE id_ambito = 3;
UPDATE ambitos_lista SET descripcion = 'Others' WHERE id_ambito = 4;
