...
ALTER TABLE `semilla_dependencia`
  ADD CONSTRAINT `semilla_dependencia_ibfk_1` FOREIGN KEY (`id_dependencia`) REFERENCES `dependencia` (`id_dependencia`) ON DELETE CASCADE ON UPDATE CASCADE;


CREATE TABLE observatorio_estado (
  id int(11) NOT NULL COMMENT 'Self-increasing identifier',
  id_observatorio int(11) NOT NULL COMMENT 'Observatory identifier',
  id_ejecucion_observatorio int(11) NOT NULL COMMENT 'Identifier of the observatory execution',
  nombre varchar(256) NOT NULL COMMENT 'Seed name',
  url varchar(256) NOT NULL COMMENT 'Seed url',
  total_url int(11) NOT NULL COMMENT 'Total URLs to be analyzed',
  total_url_analizadas int(11) DEFAULT '0',
  ultima_url varchar(7500) NOT NULL COMMENT 'Last URL analyzed',
  fecha_ultima_url datetime DEFAULT NULL COMMENT 'End date of last analyzed URL',
  actual_url varchar(7500) NOT NULL COMMENT 'URL being parsed',
  tiempo_medio int(11) DEFAULT NULL COMMENT 'Average analysis time',
...
ALTER TABLE observatorio_estado
  MODIFY id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Self-increasing identifier';
  
  
CREATE TABLE observatorio_proxy (status tinyint(1) NOT NULL, url varchar(64) NOT NULL, port varchar(5) NOT NULL);
